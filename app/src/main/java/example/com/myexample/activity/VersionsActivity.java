...
import example.com.myexample.presenter.VersionPesenter;
import example.com.myexample.view.IVersionView;

public class VersionsActivity extends AppCompatActivity implements View.OnClickListener, IVersionView {

    private ImageView back;
    /**
     * ssssss
     */
    private TextView mVscode;
    /**
     * 检测更新
     */
    private TextView mVdbtn;
    private String apkUrl;
    private VersionPesenter pesenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        pesenter = new VersionPesenter(this);
    }

    private void initView() {
        back = (ImageView) findViewById(R.id.back);
        back.setOnClickListener(this);
        mVscode = (TextView) findViewById(R.id.vscode);
        mVdbtn = (TextView) findViewById(R.id.vdbtn);
        mVdbtn.setOnClickListener(this);
        try {
            mVscode.setText(getVersionName());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
